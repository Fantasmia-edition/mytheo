...
const plans = [
  {
    ...
    badge: null,
    name: 'Le Scribe Patient',
    tagline: 'Pour découvrir à son rythme',
    ...
    features: [
      ...
      { icon: '📱', text: 'Accès à l\'app de scan' },
  ...
  },
  {
    ...
    tagline: 'Pour les aventuriers passionnés',
    ...
    features: [
      ...
      { icon: '⚡', text: 'Accès prioritaire à l\'app' },
      { icon: '🔓', text: 'Sans engagement' },
    ],
  },
]
